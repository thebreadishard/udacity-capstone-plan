...
- `Papers/` — local only, **git-ignored since 2026-09-06**: the PDFs were removed from the repository and from its history (`docs/Papers_Inventory_2026-09-06.md` at the root records how); the current plan's bibliography is the index of what is held and read.
