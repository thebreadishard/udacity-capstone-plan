# Draft P25 (2026-09-12, evening; NOT submitted to plan 05 — **the user decided 2026-09-13 (just after midnight): P25 goes to plan 05 as a proposal once the naphthalene repeat of X10 (§3) has run**; until then it stays here) — a free DFT rule inside the symmetry prior: which off-diagonal pairs the deck measures first
