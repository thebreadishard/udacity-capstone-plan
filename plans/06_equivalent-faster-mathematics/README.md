...
5. [lean/](lean/README.md) — the formal route: a Lake project on Mathlib `v4.34.0-rc2` (installed 2026-09-12); `Plan06/T1/MeasurementAlgebra.lean` holds T1 — T1a and T1c proved with their corollary (Δ + 1 probes suffice), T1b owed (`sorry`). Build with `lake exe cache get && lake build`; `.lake/` is git-ignored.
