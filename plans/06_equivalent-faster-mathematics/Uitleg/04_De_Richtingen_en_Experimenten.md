...
| X14 (13 sep) | hoeveel substitutieproducten heeft het echte naftaleen-patroon (de 141 toegestane koppelingen van X13) nodig? | **gedaan**: 9 producten = 18 gradiënten voor de hele R1-correctie, tegen 474 energieën in plan 05's deck; de gradiëntroute wint dus zodra één gradiënt minder dan 26 energieën kost. Het aantal producten is het grootste symmetrieblok (9 modes), niet het aantal koppelingen: producten groeien met M, het deck met M² |
| X15 (13 sep) | hebben de verre blokken van een PAK-Hessiaan lage rang (de aanname van O1NumHess, een artikel uit 2025 dat een Hessiaan uit ≈ 100 gradiënten haalt)? | **gedaan, negatief op ons niveau**: in de norm wel (de singuliere waarden vallen snel), maar om alle banden binnen 0,5 cm⁻¹ te houden zijn 30–83 % van de richtingen nodig, zelfs voor de uiteinden van antraceen en tetraceen op 9 bohr afstand. De les van X8 geldt ook voor rang: wat in de norm klein is, is voor bandposities niet weg te laten |
