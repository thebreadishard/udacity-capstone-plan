...
4. ~~The Module-05 target~~ — **decided 2026-09-04: adopted.** A Transformer predicting the
   support of Δ₂ in the DFT mode basis, trained on an aromatic-heavy subset of Hessian QM9 plus
