...
## Dated pointer 2026-09-22 18:1x — dataset for the first full run

The user decided (22 September, evening) that the first full run trains on the project's own corpus alone (layers A and A2); Hessian QM9 is out of that
