...
| Module 05 — Δ₂-support predictor | the DFT-vs-DFT Hessian corpus and the network — **scaffolded 12 September** (`modules/05_support_predictor/`: recipe, corpus builder in fixture mode, the Transformer in PyTorch, smoke test on the benzene dry-run tensor; Hessian QM9 located and verified, figshare 6.29 GB, not downloaded; no corpus, no result) | 20 Nov 2026 | the corpus costs DFT compute and competes with R1 |
