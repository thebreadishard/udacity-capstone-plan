...
|---|---|---|---|
| A | PAHdb computed library: scaled-harmonic DFT | v4.00; Ricca et al. 2026 | every rung except R0 — the library as served (parsed 10 September: 10,749 species) has **no benzene entry**, so line A's column at R0 is empty by construction; C₃₈₄H₄₈ is present (uid 617) |
