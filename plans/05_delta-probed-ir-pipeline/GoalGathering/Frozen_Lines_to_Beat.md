...
- **Dated note 2026-09-10 — the library as served (Module 02 atlas, first print;
  ...
  **not one transition carries 0.964 / 0.979 / 0.975** as quoted above from the paper; the library
  is scored as served and the paper's text is re-read against this before the pilot note.
  **Re-read 2026-09-10 (both papers, IOP full text).** The v4.00 paper states three factors fitted to 25 gas-phase bands (Pirali 2009's 17 IR-allowed naphthalene bands, Behlen & Rice 1981's four A_g and two B_2g, Cané 1996's one A_u and one B_1g): **0.964 for the C–H stretches near 3 µm, 0.979 for 4–9 µm, 0.975 beyond 9 µm**, and that "all spectra were computed using the larger basis set 6-31G*". The v3.00 paper (Bauschlicher et al. 2018, Table 2) gives, for the same three regions 0–1111.1 / 1111.1–2500 / > 2500 cm⁻¹: **B3LYP/6-31G* 0.979 / 0.969 / 0.960** and **B3LYP/4-31G 0.956 / 0.952 / 0.960**. The served v4.00 file carries exactly the v3.00 factors at four decimals (0.9794 / 0.9691 / 0.9597 for 6-31G*; 0.9563 / 0.9523 / 0.9595 for the fourteen 4-31G species, which the v4.00 text does not mention), with the v3.00 region boundaries. So **the library as served is scaled with the v3.00 factors, while the v4.00 paper describes a refit that is not in the file**; the differences are 0.0043 (3 µm: ≈ 13 cm⁻¹ at 3050), 0.0099 (4–9 µm: ≈ 15 cm⁻¹ at 1500) and 0.0044 (> 9 µm: ≈ 4 cm⁻¹ at 900) — of the order of the beat margins. The atlas keeps the unscaled frequencies, so both columns can be printed; **P22 — decided 2026-09-10 (decision 30, user: "voorstel is akkoord"): line A is the library as served** (the file's v3.00 factors — what every PAHdb user, and lines C and the cheap line, receive); the column at the v4.00 paper's factors is printed beside it, labelled, and claims nothing. The
...
| **PNNL/NWIR quantitative vapour-phase IR database** (Sharpe et al. 2004, item 59; naphthalene entry documented in Schneider et al. 2024, item 57) | 25 °C per the methods, 50 °C per the introduction and Fig. 6 caption (the record header decides; dated 2026-09-06), 0.112 cm⁻¹, 760 Torr N₂-broadened composite spectra; **naphthalene** present — the R1 room-temperature gas scoreboard | named 2026-09-04 before any M03 print (no-swap rule); Crossref records verified by the author; the record's stated conditions read by M03 before u_band |
| **Jet-cooled 3 µm IR–UV ion-dip spectra** (Maltseva et al. 2016, item 58) | pyrene, chrysene, triphenylene (and others), band widths down to 1 cm⁻¹ — a cold gas-phase source for the R2 **C–H-stretch family only** | named 2026-09-04; Crossref record verified by the author; abstract read by the Round-10 reviewer — **decision 25 (2026-09-08): shown, not promised, until a scoring rule for the 3 µm polyads is agreed (proposal §13 item 8)** |
| **Jet-cooled mid-IR band lists** (Lemmens et al. 2019, item 61: tetracene, 5–18 µm; Lemmens, Rijs & Buma 2021, item 62: coronene, six 6–15 µm bands — "five" until 2026-09-06) | labelled cold columns for R2 tetracene and R3 coronene; resolution term = the FEL bandwidth (≈ 1 % of frequency) | named 2026-09-05 by dated note (Ladder §2); Crossref records verified by the author; tables read by the scout; both read in full by the author 2026-09-06 |
