...
For the harmonic-against-harmonic closing of the three-band test (`probes/results_m1/BENZENE_THREE_BAND_TEST_2026-09-20.md` §6): (1) Goodman, Ozkabak & Thakur, "A benchmark vibrational potential surface: ground-state benzene", J. Phys. Chem. **95**, 9044 (1991); (2) Miani, Cané, Palmieri, Trombetti & Handy, "Experimental and theoretical anharmonic study of the benzene molecule", J. Chem. Phys. **112**, 248 (2000). Both closed access; identifiers from memory, to be Crossref-verified before the request is sent. Not yet requested.
