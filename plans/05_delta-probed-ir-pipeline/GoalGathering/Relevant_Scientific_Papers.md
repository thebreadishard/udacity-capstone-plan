...
| **77** | **Opponent line D candidate (ML, DFT-trained, charge-aware, to 150 C)** | He, J.; Mai, X.; Wang, Z., "Charge-aware machine learning for the infrared spectra of interstellar polycyclic aromatic hydrocarbons", *Astron. Astrophys.* **708**, A335 (2026), DOI 10.1051/0004-6361/202659248 | **record, Crossref-verified 2026-09-13; abstract read (OpenAlex); open access** — neural network on topological fingerprints with charge embeddings, 12,599 species, four charge states, up to 150 carbons, "near-DFT accuracy"; larger molecules limited by training data. Full text to fetch (open access) before any line-D number is frozen. |
| **78** | Opponent line D candidate (GNN, DFT-trained) | Tang, G.; He, J.; Wang, Z.; Qiu, D., "Graph neural network prediction of infrared spectra of interstellar polycyclic aromatic hydrocarbons", *Mon. Not. R. Astron. Soc.* **546**, stag283 (2026), DOI 10.1093/mnras/stag283 | **record, Crossref-verified 2026-09-13; abstract read; open access** — four GNN architectures, AFP best, Jensen–Shannon loss, best for 20–40 carbons. |
