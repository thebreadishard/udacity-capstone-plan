...
| **33** | Local-CC gradients by automatic differentiation | Zhang, Li, Ye, Berkelbach & Chan, "Performant Automatic Differentiation of Local Coupled Cluster Theories: Response Properties and Ab Initio Molecular Dynamics", JCP **161**, 014109 (2024); arXiv:2404.03129 (PySCFAD, LNO-CCSD(T)) | **OK (2026-09-03; arXiv abstract)**; full text read by the Round-7 and Round-8 Pass B reviewers: LNO spaces held fixed in the derivative; localization differentiated implicitly; (T) backward pass on the fly; memory dominated by ⟨ov|vv⟩ with `jax.checkpoint` recomputation; **no GB figures, no gradient-vs-energy wall-clock**; validated against canonical CCSD(T) AD gradients on the Baker set (3–29 atoms, cc-pVDZ), never against finite differences of its own LNO energy **Read in full 2026-09-12 for the gradient/energy cost ratio: not printed** (only summed energy+gradient+dipole wall times, Fig. S1/S4; reverse-mode AD with recomputation; benzene named an outlier through LNO symmetry breaking — the discontinuity our frozen spaces remove); reading note `notes/Reading_Note_2026-09-12_Item33_PySCFAD_Gradient_Cost.md` Step 1b/1c (same note): the cheap-gradient bound read in Baydin et al., *JMLR* 18 (2018) 1–43 (full text, open): reverse-mode cost c·ops(f), "c < 6 and typically c ∼ [2, 3]" citing Griewank & Walther 2008 (SIAM, DOI 10.1137/1.9780898717761, unread) and Baur & Strassen 1983 (*TCS* 22, 317–330, DOI 10.1016/0304-3975(83)90110-X, unread); the name "cost ratio" attributed to Griewank & Walther by a secondary source only. Local-CC analytic gradients published at MP2 level only: Pinski & Neese, *JCP* 148, 031101 (2018), DOI 10.1063/1.5011204 and 150, 164102 (2019), DOI 10.1063/1.5086544; Dornbach & Werner, *Mol. Phys.* 117, 1252 (2019), DOI 10.1080/00268976.2018.1537529 — records verified, no cost ratio in the abstracts. |
| **34** | Wang, B., Luo, S., Wang, Z., & Liu, W. (2025). O1NumHess: A fast and accurate seminumerical Hessian algorithm using only O(1) gradients. *J. Chem. Theory Comput.* 21(21), 10893–10909. DOI 10.1021/acs.jctc.5c01354; arXiv:2508.07544 (open) | Crossref record verified 2026-09-13; **read in full the same day** (arXiv text; plan 06 `Reading_Note_2026-09-13_O1NumHess.md`) | **Direct prior art for the gradient route of plan 06's S5 / cost-ladder lever C:** a Hessian from O(1) gradients by finite differences at O(1) displaced geometries, resting on an *off-diagonal low-rank* (ODLR) property of Hessians (distant atom groups couple through low-rank blocks), which reduces the independent entries from O(N²) to O(N); reported errors ≈ 2× the conventional seminumerical Hessian, ≈ 100 gradients for large systems, open-source code. Different structural assumption from plan 06's (sparsity + symmetry, exact substitution) — plan 06's X14 gives 18 gradients at naphthalene *exactly* under the symmetry prior; ODLR would apply where symmetry does not. To be read in full before P25/M2 cite the gradient route; see plan 06's novelty note of 2026-09-13. |
...
| **70** | Δ-learning with *local* CCSD(T) labels at 15 atoms (nearest cost logic to plan 05; found 13 September by the leads A–G literature check) | Qu, C.; Houston, P. L.; Conte, R.; Nandi, A.; Bowman, J. M., "Breaking the Coupled Cluster Barrier for Machine-Learned Potentials of Large Molecules: The Case of 15-Atom Acetylacetone", *J. Phys. Chem. Lett.* **12**, 4902–4909 (2021), DOI 10.1021/acs.jpclett.1c01142 | **record, Crossref-verified 2026-09-13; abstract only** (open access at the publisher): Δ-ML correction of an MP2 PES from a database of 2151 local CCSD(T) energies, trained with as few as 430; target barrier height and tunnelling splitting, not a Hessian; no aromatic. |
| **71** | Perspective on Δ-ML surfaces and force fields; names local CCSD(T) as the route to labels at 15 atoms | Bowman, J. M.; Qu, C.; Conte, R.; Nandi, A.; Houston, P. L.; Yu, Q., "Δ-Machine Learned Potential Energy Surfaces and Force Fields", *J. Chem. Theory Comput.* **19**, 1–17 (2022), DOI 10.1021/acs.jctc.2c01034 | **record, Crossref-verified 2026-09-13; abstract only** (open access at the publisher). |
| **72** | Naphthalene ν46 band origin, rotationally resolved, room temperature (Module 03 origin column) | Albert, S.; Albert, K. K.; Lerch, P.; Quack, M., "Synchrotron-based highest resolution Fourier transform infrared spectroscopy of naphthalene (C10H8) and indole (C8H7N) and its application to astrophysical problems", *Faraday Discuss.* **150**, 71 (2011), DOI 10.1039/c0fd00013b | **record, Crossref-verified 2026-09-13; abstract only** (closed): ν̃₀(ν46) = 782.330949 cm⁻¹ at 0.0008 cm⁻¹ resolution (SLS); PDF request item 32. |
| **73** | Naphthalene ν46 band origin, rotationally resolved, jet-cooled; ν47, ν48 far-IR (Module 03 origin column) | Pirali, O.; Goubet, M.; Huet, T. R.; Georges, R.; Soulard, P.; Asselin, P.; Courbe, J.; Roy, P.; Vervloet, M., "The far infrared spectrum of naphthalene characterized by high resolution synchrotron FTIR spectroscopy and anharmonic DFT calculations", *Phys. Chem. Chem. Phys.* **15**, 10141 (2013), DOI 10.1039/c3cp44305a | **record, Crossref-verified 2026-09-13; abstract only** (closed): ν46 under supersonic-jet conditions (Jet-AILES), ν47 (474) and ν48 (167 cm⁻¹) at room temperature; fitted origins in the full text; PDF request item 33. |
| **74** | Nearest existing "large PAH in, harmonic IR spectrum out" ML pipeline (software record; opponent line D candidate; mandate ledger obstacle 14) | `zwAstroChem/ML-DH-PAH-IR`, "Code for High-Throughput Computation of Infrared Spectra of Polycyclic Aromatic Hydrocarbons Using a Machine-Learning-Based Double-Harmonic Model", GitHub repository created 2026-07-23, no licence stated; components: Montes-Campos, H.; Carrete, J.; Bichelmaier, S.; Varela, L. M.; Madsen, G. K. H., *J. Chem. Inf. Model.* **62**, 88–101 (2021), DOI 10.1021/acs.jcim.1c01380 (NNFF); Metcalf, D. P.; Jiang, A.; Spronk, S. A.; Cheney, D. L.; Sherrill, C. D., *J. Chem. Inf. Model.* **61**, 115–122 (2020), DOI 10.1021/acs.jcim.0c01071 (EPNN) | **repository README read 2026-09-13 via the GitHub API; the paper itself NOT FOUND in Crossref/OpenAlex/arXiv that night** — re-check monthly; component DOIs Crossref-verified. |
| **75** | Composite double-harmonic IR spectra from semiempirical and ML potentials (prior art for the pipeline's shape step) | Pracht, P.; Pillai, Y.; Kapil, V.; Csányi, G.; Gönnheimer, N.; Vondrák, M.; Margraf, J. T.; Wales, D. J., "Efficient Composite Infrared Spectroscopy: Combining the Double-Harmonic Approximation with Machine Learning Potentials", *J. Chem. Theory Comput.* **20**, 10986–11004 (2024), DOI 10.1021/acs.jctc.4c01157 | **record, Crossref-verified 2026-09-13; abstract only.** |
| **76** | Learned exchange-correlation functionals, open implementation (lead A; mandate ledger obstacle 15) | Gao, N.; Eberhard, E.; Günnemann, S., "Learning Equivariant Non-Local Electron Density Functionals", arXiv:2410.07972 (2024; ICLR 2025 per the repository); Eberhard, E. S.; Thiede, L. A.; Aldossary, A.; Burger, A.; Gao, N.; Bhethanabotla, V.; Aspuru-Guzik, A.; Günnemann, S., "Derivative Informed Learning of Exchange-Correlation Functionals", arXiv:2606.04279 (2026; ICML 2026 per the repository); software `ESEberhard/ML4DFT` (MIT) | **arXiv records verified through OpenAlex 2026-09-13; abstracts not yet read; not installed.** |
| **77** | **Opponent line D candidate (ML, DFT-trained, charge-aware, to 150 C)** | He, J.; Mai, X.; Wang, Z., "Charge-aware machine learning for the infrared spectra of interstellar polycyclic aromatic hydrocarbons", *Astron. Astrophys.* **708**, A335 (2026), DOI 10.1051/0004-6361/202659248 | **record, Crossref-verified 2026-09-13; **read in full 2026-09-13 from the open-access HTML** (`Papers/_txt/He2026_AA708_A335_fullhtml.txt`; reading note `notes/Reading_Note_2026-09-13_LineD_ML_PAH_IR_Predictors.md`) — neural network on topological fingerprints with charge embeddings, 12,599 species, four charge states, up to 150 carbons, "near-DFT accuracy"; larger molecules limited by training data. Full text to fetch (open access) before any line-D number is frozen. |
| **78** | Opponent line D candidate (GNN, DFT-trained) | Tang, G.; He, J.; Wang, Z.; Qiu, D., "Graph neural network prediction of infrared spectra of interstellar polycyclic aromatic hydrocarbons", *Mon. Not. R. Astron. Soc.* **546**, stag283 (2026), DOI 10.1093/mnras/stag283 | **record, Crossref-verified 2026-09-13; **read in full 2026-09-13 from arXiv:2602.12560 v1** (`Papers/lineD/`, text in `Papers/_txt/`) — four GNN architectures, AFP best, Jensen–Shannon loss, best for 20–40 carbons. |
| **79** | Opponent line D candidate (LLM on molecular strings, DFT-trained) | Liu, Y.; Wang, Z.; Qiu, D., "AstroSpec-LLM: a large language model framework for high-throughput infrared spectral prediction of interstellar PAHs", *Mon. Not. R. Astron. Soc.* **549**, stag893 (2026), DOI 10.1093/mnras/stag893 | **record, Crossref-verified 2026-09-13; abstract read; open access** — transformer encoder fine-tuned on 24,146 PAH spectra, charge-sensitive. |
| **80** | ML dipole moments of non-equilibrium PAHs (same group; intensity side) | Xu, X.; Mai, X.; Wang, Z., "Multipole-enhanced machine-learning dipole moment predictions in non-equilibrium polycyclic aromatic hydrocarbons", *Phys. Scr.* **101**, 306004 (2026), DOI 10.1088/1402-4896/ae8c84 | **record, Crossref-verified 2026-09-13; abstract not fetched (API limit).** |
| **81** | Origin of opponent line D (ML prediction of PAH IR spectra from fingerprints) | Kovács, P.; Zhu, X.; Carrete, J.; Madsen, G. K. H.; Wang, Z., "Machine-learning Prediction of Infrared Spectra of Interstellar Polycyclic Aromatic Hydrocarbons", *Astrophys. J.* **902**, 100 (2020), DOI 10.3847/1538-4357/abb5b6 | **record, Crossref-verified 2026-09-13.** |
| **82** | Line D, the group's programmatic letter | Wang, Z., "Full-spectrum infrared fingerprinting: A transformative AI paradigm for interstellar polycyclic aromatic hydrocarbons", *Astron. Astrophys.* **710**, L17 (2026), DOI 10.1051/0004-6361/202659999 | **record, Crossref-verified 2026-09-13; not read.** |
| **83** | Open VPT2 for psi4 (positions; the Δ₂ = 0 null column's anharmonic step; obstacle 17) | Nelson, P. M.; Sherrill, C. D., "pyVPT2: Interoperable software for anharmonic vibrational frequency calculations", *J. Chem. Phys.* **162**, 032501 (2025), DOI 10.1063/5.0251445 | **record, Crossref-verified 2026-09-14; repository read through the GitHub API (BSD-3-Clause; harmonic intensities only); abstract read 2026-09-14 (OpenAlex): VPT2 frequencies from any QCEngine-interfaced program, energies/gradients/Hessians optionally distributed through QCFractal — frequencies only, intensities not mentioned; full text not read.** |
| **84** | VPT2 intensities, general formulation (idea I6's formulae) | Bloino, J.; Barone, V., "A second-order perturbation theory route to vibrational averages and transition properties of molecules: General formulation and application to infrared and vibrational circular dichroism spectroscopies", *J. Chem. Phys.* **136**, 124108 (2012), DOI 10.1063/1.3695210 | **record, Crossref-verified 2026-09-14; abstract read 2026-09-14 (OpenAlex, 397 citations): a general second-order formulation for any property expanded as a Taylor series to **third order** in the normal coordinates (so I6 needs the dipole's first, second and third derivatives for fundamentals; second for two-quantum bands), applied to IR and VCD; full text not read.** |
| **85** | Anharmonic intensities incl. overtones and combination bands, resonance treatment (idea I6) | Bloino, J.; Biczysko, M.; Barone, V., "Anharmonic Effects on Vibrational Spectra Intensities: Infrared, Raman, Vibrational Circular Dichroism, and Raman Optical Activity", *J. Phys. Chem. A* **119**, 11862–11874 (2015), DOI 10.1021/acs.jpca.5b10067 | **record, Crossref-verified 2026-09-14; abstract read 2026-09-14 (OpenAlex, 146 citations): GVPT2 with first- and second-order resonances included for both frequencies and intensities (IR, Raman, VCD, ROA), validated on methyloxirane and halogenated azetidinones; the resonance-thresholds paper for I6; full text not read.** |
| **86** | Composite CCSD(T)/CBS harmonic frequencies at double-ζ cost (idea I7 / probe M3 context) | Chan, B.; Ho, J., "Simple Composite Approach to Efficiently Estimate Basis Set Limit CCSD(T) Harmonic Frequencies and Reaction Thermochemistry", *J. Phys. Chem. A* **127**, 10026–10031 (2023), DOI 10.1021/acs.jpca.3c06027 | **record, Crossref-verified 2026-09-14; abstract read (OpenAlex): G3(MP2)-type terms + CCSD(T)-F12 give ≈ 2 cm⁻¹ of CBS CCSD(T) harmonic frequencies at double-ζ cost on 61 + 31 (HFREQ2014) small molecules — F12 not in the pipeline's open stack; full text not read.** |
| **87** | CCSD(T)/CBS harmonic-frequency benchmark set (small molecules; I8) | Howard, J. C.; Tschumper, G. S., "Benchmark Structures and Harmonic Vibrational Frequencies Near the CCSD(T) Complete Basis Set Limit for Small Water Clusters: (H₂O)n = 2, 3, 4, 5, 6", *J. Chem. Theory Comput.* **11**, 2126–2136 (2015), DOI 10.1021/acs.jctc.5b00225 | **record, Crossref-verified 2026-09-14; title only (water clusters — not aromatic); not read.** |
| **88** | Basis-set-limit CCSD(T) harmonic frequencies (small molecules; I8) | Tew, D. P.; Klopper, W.; Heckert, M.; Gauss, J., "Basis Set Limit CCSD(T) Harmonic Vibrational Frequencies", *J. Phys. Chem. A* **111**, 11242–11248 (2007), DOI 10.1021/jp070851u | **record, Crossref-verified 2026-09-14; not read.** |
...
## Additions of 2026-09-19 (author; records only, nothing read)

- **Liu, R., Qu, E., Kreiman, T., Blau, S. M., Krishnapriyan, A. S. 2026, arXiv:2602.04861 (cs.LG; accepted at ICML 2026), "From Evaluation to Design: Using Potential Energy Surface Smoothness Metrics to Guide Machine Learning Interatomic Potential Architectures".** Found by the user on arXiv on 19 September while searching for the smoothness literature. **Not a source for the local-correlation smoothness question (L1 of the PI assessment of 19 September):** it concerns whether a *trained* potential reproduces the physical smoothness of the quantum surface, not the smoothness of a local-correlation surface itself. **Possibly relevant for pipeline A:** its smoothness metrics are a way to judge the network's output outside the training set, beside the per-family error against experiment. Status: abstract only; to be read when pipeline A's evaluation is designed (Module 05 RECIPE metrics). Not in the proposal's §14.
- **PDF request sent to the supervisor, 19 September (the user):** Mata & Werner 2006 (10.1063/1.2364487), Russ & Crawford 2004 (10.1063/1.1759322), Subotnik & Head-Gordon 2005 (10.1063/1.2000252), Mackie et al. 2015 (10.1063/1.4936779), Mackie et al. 2016 (10.1063/1.4961438). The first three are the named prerequisite of gate A (PI assessment §3); the two Mackie papers are opponent line B with the supervisor as co-author. Reading status of all five: not read; their verification status in this file is unchanged until the PDFs arrive.

## 20 September 2026 — five PDFs from the supervisor, filed in `Papers/` and read in full

Items **68** (Russ & Crawford 2004), **69** (Subotnik & Head-Gordon 2005), **67** (Mata & Werner 2006), **12** (Mackie et al. 2015 and 2016): PDFs received 20 September 18:05, read the same evening; reading note `notes/Reading_Note_2026-09-20_Supervisor_PDFs_L1_Smoothness_and_Mackie.md`. Consequences recorded there: (a) Mata & Werner 2006 §II names frozen domains for numerical Hessians as standard practice — gate A's claim is reworded to the transport of LNO-type spaces (no atom-list domain to freeze) with the projection term measured; (b) Russ & Crawford's step sizes (0.1–1 mE_h, near equilibrium in conjugated systems) are the reference scale for our 0.05–1.2 µE_h residuals; (c) Subotnik & Head-Gordon's threshold remark and 'smooth for the chemist' criterion become sentences in the communication; (d) Mackie's per-region accuracies (mid-IR averages 5.6–9.9 cm⁻¹; 0.41 % ± 0.63 % vs matrix, 0.53 % ± 0.95 % vs hot gas, −0.13 % ± 0.25 % C–H stretch vs jet) are line B's numbers from the source; their pipeline needs polyads in VPT2 (pyVPT2 to be checked); their closing hope for family-wide generalisation is the proposal's motivation sentence.

## 20 September 2026, 20:0x — six more PDFs from the supervisor: item 12 (3)–(8)

Mackie 2018 (JCP 149, 134302), Mackie 2021 (TCA 140, 124), Mackie 2022 (JPCA 126, 3198), Esposito 2024 (JCP 160, 114312; Mol. Phys. e2261570; Mol. Phys. e2252936) received 20 September, filed in `Papers/`, read (abstract, methods, conclusions, named passages) — reading note §6. Item 12 now: eight of ten held and read (the two 2024 open-access papers were held since 8 September); nothing outstanding from the request except the individual remaining Esposito 2024 letter if it exists beyond these. Consequences: cascade emission = 0 K peak + energy-dependent red wing (no blanket shift) for the profile step; large-PAH out-of-plane anharmonic instabilities (Mackie 2021) recorded as a risk for R3; **line B for cations** exists (Esposito 2024, Mol. Phys. e2252936: pyrene⁺, phenanthrene⁺, pentacene⁺ at B3LYP/N07D + SPECTRO) — obstacle 9's opponent row has a source; 3-quanta polyads needed for ethynyl-substituted species (Esposito 2024 ×2).

## 21 September 2026 — two PDFs to ask of the supervisor (experimental harmonic frequencies of benzene)

For the harmonic-against-harmonic closing of the three-band test (`probes/results_m1/BENZENE_THREE_BAND_TEST_2026-09-20.md` §6): (1) Goodman, Ozkabak & Thakur, "A benchmark vibrational potential surface: ground-state benzene", J. Phys. Chem. **95**, 9044–9058 (1991), DOI 10.1021/j100176a008; (2) Miani, Cané, Palmieri, Trombetti & Handy, "Experimental and theoretical anharmonicity for benzene using density functional theory", J. Chem. Phys. **112**, 248–259 (2000), DOI 10.1063/1.480577. **Both Crossref-verified 21 September 2026, 06:2x** (titles and pages corrected from the memory versions; the Crossref query also surfaced Thakur, Goodman & Ozkabak, JCP **84**, 6642 (1986) — the planar fundamentals — and Cané, Miani & Trombetti, J. Mol. Spectrosc. **183**, 204 (1997), anharmonic constants of C₆H₆, both possibly useful, not requested). Closed access; to be asked of the supervisor.
*22 September 07:2x:* **both received from the supervisor** (local copies `Papers/Goodman_Ozkabak_Thakur_1991_JPC_95_9044.pdf`, `Papers/Miani_2000_JCP_112_248.pdf`); Goodman Tables I–II and Miani Tables II and VII transcribed to `probes/data/benzene_benchmark_goodman1991_miani2000.json`; comparison in `probes/results_vpt2/benzene_benchmark_2026-09-22.md` (anharmonic shifts agree with Miani to a median 4.3 cm⁻¹; the residual of our bands is the 6-31G* harmonic). Miani's method: B3LYP/TZ2P harmonic and cubic/quartic force field by finite differences, VPT2 with Fermi and l-doubling treatment (ε = 0/50/100 cm⁻¹ windows).
