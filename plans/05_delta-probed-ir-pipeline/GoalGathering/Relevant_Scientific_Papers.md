...
- **Units and temperature.** Composites are normalised to **1 ppm-m at 296 K, 1 atm**; the burden
  ...
  Fig. 6 caption ("Resultant composite spectra (50 °C)"). The paper does not resolve this for
...
- **Integrated cross sections (Table 5, coronene gas 770 K, σΔλ in 10⁻²⁵ cm³; ±20 %
  stated in §3.2.3):** 3.3 µm 29; 5.3 µm 7.2; 5.6 µm 5.3; 5.9 µm 7.3; 6.2 µm 8.8; 7.6 µm 29;
