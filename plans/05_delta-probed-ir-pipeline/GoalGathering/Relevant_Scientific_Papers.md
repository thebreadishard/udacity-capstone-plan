...
| **48** | LNO-CC energy code the side project extends | pyscf-forge, `pyscf/lno/`: `domain.py, lno.py, lnoccsd.py, lnoccsd_t.py, make_lno_rdm1.py, tools.py, ulno.py, ulnoccsd.py, ulnoccsd_t.py, ulnoccsd_t_slow.py, test/`; CHANGELOG 1.1.0 (2026-02-20) "LNO-CCSD for molecules and PBC systems" is a summary line; github.com/pyscf/pyscf-forge | **OK (2026-09-04; directory listing fetched by the Round-8 Pass B reviewer and by the author)** — **LNO-CCSD(T) is present, closed- and open-shell**; behaviour with frozen spaces is probe M1's measurement |
