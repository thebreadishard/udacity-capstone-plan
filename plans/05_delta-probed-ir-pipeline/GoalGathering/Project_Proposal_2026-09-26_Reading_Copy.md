...
- **25 September 09:0x (dated correction).** The 25 September note in §3.5 first said "flat on bare parents"; that was the superseded 23 September run with benzene's corrupted target. Corrected in place with a dated remark; the corrected-target curve is 0.47 → 0.45 → 0.43 (ledger 23 September 12:5x).
