...
2026-09-03; rows 18–27 from 2026-09-04.
...
| 22 | Q8 on whatever the pipeline produced | Q8 on **direct blocks** (reference Hessian at R0–R1; a prior-free direct-block probe at R2–R3), with a relative block-disagreement tolerance η₈; an **anthracene** locality probe as a dated bonus between R1 and R2 | Ladder §3, Distilled Q8, Budget §4 |
...
| 25 | Anchor code: ORCA DLPNO by default | **Candidate anchor code: the pyscf-forge LNO-CC code** (released as LNO-CCSD; (T) verified at M1), because it is the one in which spaces can be frozen and gradients pursued | Distilled §3 |
