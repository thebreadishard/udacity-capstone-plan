...
| 5 | P3 effect size (learned prior's required saving in K or ρ at fixed K), also on PAH held-out tensors | dry-run K = 448 mode E; the structural prior's K (57 same-representation pairs → K ≈ 220–380 at R1) | Module 05 corpus (factory timing test owed) | effect size |
