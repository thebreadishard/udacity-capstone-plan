...
*Bijgewerkt 25 september 17:1x:* route 2 (de Mackie-diagnose op hun niveau) is voor naftaleen uitgelezen: schone kwartische constanten (tweeroutesverschil mediaan 0,0, 90e percentiel 0,2 cm⁻¹) en VPT2-fundamentalen binnen 1,2 cm⁻¹ RMS van de rotationeel opgeloste bandoorsprongen (ν46: +0,2). Voor het gesprek: de voorwaarde voor de Mackie 2021-vraag is vervuld; de vraag zelf wacht op de vierringmolecule na de 28e.
