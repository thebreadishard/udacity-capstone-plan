...
Paths are relative to `plans/05_delta-probed-ir-pipeline/`. Python: the repository `.venv` (3.13) for modules 05–07; the WSL `qc05` or a rented
machine's `m05` environment for anything that imports psi4/pyscf/torch with the corpus.*
