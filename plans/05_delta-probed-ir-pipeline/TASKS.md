...
| P2 stage-1 search (lr × width, patience 20; 18 fits) | the learned embedding gets a fair chance before any sentence about it (the user, 12:1x) | laptop, one thread, `modules/standout_pattern_proposer/out/p2s1_*`, log `out/p2_stage1_2026-09-26.log` | stage 1 read 16:4x: lr 1e-3, w 128 chosen (val 0.315 vs P1 0.359); shipped as `out/p2s1`; pools with it queued (`chain_p2s1`) behind the wide pool; next: stage 2 ranking loss | stage 1 done; pools Sun morning |
