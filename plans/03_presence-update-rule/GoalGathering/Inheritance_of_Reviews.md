...
| R4A-2 | Adopted-vs-draft status drift | **Carried.** This folder is **draft as of 2026-09-01.** Plans 01/02 were removed from the tree on 2026-09-01 (git history only). | README status banner |
