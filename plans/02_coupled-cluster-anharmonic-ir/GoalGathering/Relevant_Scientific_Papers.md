...
16. **Infrared Spectroscopy of Matrix-Isolated PAHs** (Hudgins & Sandford, *J. Phys. Chem. A* **102**, 329, 1998)
    - *URL:* [Ar-matrix PAH spectra](https://pubs.acs.org/doi/10.1021/jp9834816) · DOI:10.1021/jp9834816
    - *Significance (added 2026-08-27):* **Not yet verified against the primary text — cited here from a third-hand summary and flagged accordingly.** Argon-matrix band positions for the C₁₈H₁₂ isomers used in this repository's controlled bay series, reported as tetracene ≈ 742.9, triphenylene ≈ 740.8 and chrysene ≈ 744–748 cm⁻¹. If those numbers hold, the measured quartet band barely moves with bay count, whereas B3LYP/6-31G* puts the same three at 735.0, 733.8 and 751.8 cm⁻¹. That would mean the +16.8 cm⁻¹ chrysene jump is a property of the functional and not of the molecule, and the repository's own bay conclusion would be right for a partly wrong reason. Verifying this against the paper itself is a prerequisite before either the conclusion or the numbers are quoted anywhere.
